...
- Used multiple_trigger_app.py Flask API app to simulate the POST request with ngrok
```bash
curl -X POST https://blowfly-unrenowned-jordy.ngrok-free.dev/trigger      -H "Content-Type: application/json"      -d '{
